...
(function () {
  let currentButton;
  // Get JSON
  // Convert JSON into notes
  // Change notes to blocks
  //  - Currently we are just doing play block (no repeating)
  // event listener
  // notice button has been licked
  // call composeBlocks function which 

  document.getElementById('got-json').addEventListener('click',()=>
  composeBlocks({
    "score-partwise": {
      "$version": "3.1",
      "identification": {
  ...
  function composeBlocks (scoreJSONObj) {
    console.log('compose bloacks', scoreJSONObj);
  }
